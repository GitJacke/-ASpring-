# 介绍
 ...
   主要功能：能友好的用java处理任何发送的C结构体对象，并且能发送java对象转换成C结构体接收的二进制。<br/>
# 功能说明
1、基于spring框架开发<br/>
2、对于结构体定义采用可视化XML配置，便于维护与调试，防止协议多次修改带来的麻烦。<br/>
3、所有关健解析操作都基于接口开发，有默认实现，也可以用于自定义实现，能满足所有特殊业务解析需求。<br/>
4、配置简单，使用方便、易上手。<br/>
# 使用实例<br/>
1、全局配置
```xml
